...
- Pinned the self-compiled kallisto (`v0.52.0`) and bustools (`v0.45.1`) to tagged releases. The clones tracked upstream master, which is not reproducible and regressed into a `std::bad_alloc` in bustools correct.
