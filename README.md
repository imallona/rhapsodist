...
- `sim_kallisto.yaml`: kallisto only, sampletags off. Isolates the kallisto mode and its self-compiled kallisto/bustools build; run by the manual `integration-kallisto` CI job.
